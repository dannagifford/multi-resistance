function [fitresult, gof] = B_nal(time, meanC_1, meanC_2, meanC_3, meanC_4, meanC_5, meanC_6, meanC_7)
...
%  Auto-generated by MATLAB on 04-Oct-2018 02:11:20
...
opts.StartPoint = [0.4 0.9 0.4 1 0.744074260367462 5];
...
opts.Display = 'Off';
opts.Lower = [0 0 0 0 0 0];
opts.StartPoint = [0.9 0.5 0.35 0.6099 0.4 6];
opts.Exclude = excludedPoints;
...
opts.Display = 'Off';
opts.Lower = [0 0 0 0 0 0];
opts.StartPoint = [0.4 0.8 0.4 0.6 0.2399 5];
opts.Exclude = excludedPoints;
...
opts.Display = 'Off';
opts.Lower = [0 0 0 0 0 0];
opts.StartPoint = [0.9 0.489901388512224 0.500022435590201 0.167927145682257 0.978680649641159 5];
opts.Exclude = excludedPoints;
...
opts.Display = 'Off';
opts.Lower = [0 0 0 0 0 0];
opts.StartPoint = [0.500471624154843 0.471088374541939 0.805489424529686 0.0596188675796392 0.681971904149063 5];
opts.Exclude = excludedPoints;
...
opts.Display = 'Off';
opts.Lower = [0 0 0 0 0 0];
opts.StartPoint = [0.4 1 0.489901388512224 0.096730025780867 0.818148553859625 5];
opts.Exclude = excludedPoints;
...
opts.Display = 'Off';
opts.Lower = [0 0 0 0 0 0];
opts.StartPoint = [0.5 0.149865442477967 0.0596188675796392 0.659605252908307 0.518594942510538 5];
opts.Exclude = excludedPoints;
